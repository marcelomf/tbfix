...
module.exports = {
  name: 'mmf_20m2',
  description: 'Atualmente esta estrategia simplesmente utiliza: sar macd ta_macd trend_ema pivot momentum.',
  ...
  onReport: function (s) {
    var cols = []
    return cols.concat(sar.onReport(s), macd.onReport(s), trend_ema.onReport(s), pivot.onReport(s), momentum.onReport(s))
  }
}
