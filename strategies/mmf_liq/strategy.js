...
var vv = module.exports = {
  name: 'mmf_liq',
  description: 'Atualmente esta estrategia simplesmente utiliza: sar macd ethlers_ft momentum.',
  ...
  fix_options: function(s) {
    s.sar_options = s.mmf_liq_options
    s.ethlers_ft_options = s.mmf_liq_options
    s.momentum_options = s.mmf_liq_options
    s.macd_options = s.mmf_liq_options
  },
  ...
  onReport: function (s) {
    // var cols = []
    // return cols.concat(sar.onReport(s), macd.onReport(s), ehlers_ft.onReport(s), momentum.onReport(s))
  },
