...
module.exports = {
  ...
  calculate: function (s) {
    ...
    bollinger(s, 'bollinger', s.trend_bollinger_options.bollinger_size)
  },
  ...
  onPeriod: function (s) {
    ...
    if (s.period.bollinger) {
      if (s.period.bollinger.upperBound && s.period.bollinger.lowerBound) {
        ...
        if (s.period.close > (upperBound / 100) * (100 - s.trend_bollinger_options.bollinger_upper_bound_pct)) {
          s.last_hit_bollinger = 'upper'
        } else if (s.period.close < (lowerBound / 100) * (100 + s.trend_bollinger_options.bollinger_lower_bound_pct)) {
