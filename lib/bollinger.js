...
module.exports = function bollinger (s, key, length, source_key) {
  ...
  if (s.lookback.length > length) {
    ...
    const time = s.bollinger_options ? s.bollinger_options.bollinger_time : s.trend_bollinger_options.bollinger_time
    const result = bollingerbands(data, length, time)
